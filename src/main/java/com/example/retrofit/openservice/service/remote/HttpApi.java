...
public interface HttpApi {
 ...
 /*
  *
      *据国内城市区域代码获取国内1天的生活指数预报信息，直连中央气象局数据，每天更新12次。
      *：空调开启指数、过敏指数、晨练指数、舒适度指数、穿衣指数、钓鱼指数、防晒指数、逛街指数、太阳镜指数、感冒指数、干燥指数、划船指数、交通指数、路况指数
      *晾晒指数、美发指数、夜生活指数、啤酒指数、放风筝指数、空气污染扩散条件指数、
      *妆指数、旅游指数、紫外线强度指数、风寒指数、洗车指数、心情指数、运动指数、约会指数、雨伞指数、中暑指数、戴口罩指数。
      *
      *
      *
      * 参数名       | 必选 | 类型     | 说明          | 备注（示例）                          |
